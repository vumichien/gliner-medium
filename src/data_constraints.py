food_sectors = [
    ...
    # Ethnic Cuisine Specializations
    "Mexican Cuisine",
    "Chinese Cuisine",
    "Indian Cuisine",
    ...
    # Healthy Eating Specializations
    "Vegan Meals",
    "Vegetarian Dishes",
    "Gluten-Free Options",
    "Keto Meals",
    ...
    # Bakery and Confectionery Specializations
    "Artisan Breads",
    "Pastries",
    "Cakes and Pies",
    ...
    # Dietary Restriction Specializations
    "Gluten-Free",
    "Dairy-Free",
    "Nut-Free",
    "Low-Sodium",
